...
| `docs/03-bridge-plugin.md` | 03 · DSH 桥接插件（host 半）设计：`dsh-plugin/` | — | 343 | 9 | 20 |
...
| `docs/CHANGELOG.md` | 变更记录（CHANGELOG） | v3.0 | 741 | 29 | 0 |
...
| `详细设计文档.md` | DSH Web Companion · 详细设计规范说明书 | v3.25 | 878 | 16 | 31 |
