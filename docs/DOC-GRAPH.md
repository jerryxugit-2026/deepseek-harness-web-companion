...
| `README.md` | DSH Web Companion（Antigravity Web Companion） | — | 106 | 9 | 0 |
...
| `docs/CHANGELOG.md` | 变更记录（CHANGELOG） | v3.0 | 1034 | 40 | 0 |
...
| `详细设计文档.md` | DSH Web Companion · 详细设计规范说明书 | v3.36 | 925 | 16 | 42 |
